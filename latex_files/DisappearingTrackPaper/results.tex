...
\begin{center}
\subfigure[]{
\includegraphics[width=0.44\textwidth]{figures/results/Public/FourLayer_middleMET_CaloSide_highpt_postfit.pdf}\label{fig:VR_N1:a}
}
\subfigure[]{
\includegraphics[width=0.44\textwidth]{figures/results/Public/ThreeLayerNotSP_middleMET_CaloVeto_highpt_postfit.pdf}\label{fig:VR_N1:b}
}
\subfigure[]{
\includegraphics[width=0.44\textwidth]{figures/results/Public/ThreeLayerSP_middleMET_CaloVeto_highpt_postfit.pdf}\label{fig:VR_N1:c}
}\\
\end{center}
\vspace{-0.75cm}
...
\begin{center}
\subfigure[]{
\includegraphics[width=0.44\textwidth]{figures/results/Public/FourLayer_highMET_CaloVeto_highpt_postfit.pdf}\label{fig:SRA:a}
}
\subfigure[]{
\includegraphics[width=0.44\textwidth]{figures/results/Public/FourLayer_middleMET_CaloVeto_highpt_postfit.pdf}\label{fig:SRA:b}
}\\
\subfigure[]{
\includegraphics[width=0.44\textwidth]{figures/results/Public/ThreeLayerNotSP_highMET_CaloVeto_highpt_postfit.pdf}\label{fig:SRA:c}
}
\subfigure[]{
\includegraphics[width=0.44\textwidth]{figures/results/Public/ThreeLayerSP_highMET_CaloVeto_highpt_postfit.pdf}\label{fig:SRA:d}
}
\end{center}
\vspace{-0.5cm}
...
\begin{center}
  \subfigure[]{
  \includegraphics[width=0.45\textwidth]{figures/results/Public/wino.pdf}
    \label{fig:results:WinoFull}
    }
  \subfigure[] {
  \includegraphics[width=0.45\textwidth]{figures/results/Public/dm_wino_combined.pdf}
...
\begin{center}
  ...
  \includegraphics[width=0.45\textwidth]{figures/results/Public/higgsino_combined.pdf}
    \label{fig:results:HiggsinoFull}
    }
  \subfigure[] {
  \includegraphics[width=0.45\textwidth]{figures/results/Public/dm_higgsino_combined.pdf}
...
\begin{center}
  \subfigure[]{
  \includegraphics[width=0.45\textwidth]{figures/results/Public/cmssm_stau.pdf}
    \label{fig:results:cmssm_stau}
    }
  \subfigure[]{
  \includegraphics[width=0.45\textwidth]{figures/results/Public/gmsb_stau.pdf}
