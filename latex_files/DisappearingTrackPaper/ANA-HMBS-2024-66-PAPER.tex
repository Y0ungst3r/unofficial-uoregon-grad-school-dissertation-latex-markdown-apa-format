...
\RequirePackage{atlaslatexpath}
% Comment out the above line if the files are in a central location, e.g. $HOME/texmf.
%-------------------------------------------------------------------------------
\documentclass[PAPER, atlasdraft=false, cernpreprint, UKenglish]{atlasdoc}
...
%-------------------------------------------------------------------------------
% Extra packages:
\usepackage[subfigure]{atlaspackage}%q
\usepackage{multirow}
...
\addbibresource{ANA-HMBS-2024-66-PAPER.bib}
...
% Add your own definitions here (file ANA-HMBS-2024-66-PAPER-defs.sty).
\usepackage{atlasbsm}
...
\input{ANA-HMBS-2024-66-PAPER-metadata}
...
\label{sec:DataAndMC}
%-------------------------------------------------------------------------------
\input{sections/data_mc.tex}

%-------------------------------------------------------------------------------
\section{Event reconstruction}
\label{sec:Reco}
%-------------------------------------------------------------------------------
\input{sections/reco.tex}
...
% \include{ANA-HMBS-2024-66-PAPER-auxmat}
%-------------------------------------------------------------------------------

%-------------------------------------------------------------------------------
% Extra tables etc. for HepData - comment in the following line if you have any.
% \include{ANA-HMBS-2024-66-PAPER-hepdata}
%-------------------------------------------------------------------------------
