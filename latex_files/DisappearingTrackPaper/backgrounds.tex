...
\centering
  ...
  \includegraphics[width=\textwidth]{../figures/background/Public/template_original_4layer.pdf}
    \caption{}
      \label{fig:bkg:34_layer_Template}
  \end{subfigure}
  \begin{subfigure}{0.44\textwidth}
  \includegraphics[width=\textwidth]{../figures/background/Public/h_weight_d0sig_3layer_z0cr_to_4layer_lowmet.pdf}
    \caption{}
    \label{fig:bkg:fake_SF_d0}
      \end{subfigure}

    \begin{subfigure}{0.44\textwidth}
  \includegraphics[width=\textwidth]{../figures/background/Public/tracklet_vcpt_4layer_label.pdf}
    \caption{}
...
\centering
  ...
  \includegraphics[width=\textwidth]{../figures/background/Public/factor_comparison_electron.pdf}
    \caption{}
      \label{fig:bkg:el_Template}
    \end{subfigure}
  \begin{subfigure}{0.45\textwidth}
  \includegraphics[width=\textwidth]{../figures/background/Public/m_h_tfpix_ele_pt_incl.pdf}
    \caption{}
    \label{fig:bkg:el_TF_trk}
   \end{subfigure}
  \begin{subfigure}{0.45\textwidth}
  \includegraphics[width=\textwidth]{../figures/background/Public/tf_caloveto_1d.pdf}
    \caption{}
      \label{fig:bkg:el_TF_calo}
    \end{subfigure}
  \begin{subfigure}{0.45\textwidth}
  %\includegraphics[width=0.45\textwidth]{../figures/background/Public/smearing_function_with_band.pdf}
  \includegraphics[width=\textwidth]{../figures/background/Public/smearing_function_with_band_ver2.pdf}
    \caption{}
